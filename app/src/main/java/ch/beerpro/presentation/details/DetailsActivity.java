...
public class DetailsActivity extends AppCompatActivity implements OnRatingLikedListener, OnNoteListener {
    ...
    private NotesRecyclerViewAdapter noteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteAdapter = new NotesRecyclerViewAdapter(this);
        recyclerView.addItemDecoration(new DividerItemDecoration(this, layoutManager.getOrientation()));
        noteRecyclerView.addItemDecoration(new DividerItemDecoration(this, noteLayoutManager.getOrientation()));

        model.getBeer().observe(this, this::updateBeer);
        model.getRatings().observe(this, this::updateRatings);
        model.getWish().observe(this, this::toggleWishlistView);
        model.getNotes().observe(this, this::updateNotes);
    ...
    public void showBottomSheetDialog() {
        ...
        if(!model.getNotes().getValue().isEmpty()) {
            Button addNote = view.findViewById(R.id.addPrivateNote);
            addNote.setText("Private Notiz ändern");
        }
        view.findViewById(R.id.addToFridge).setOnClickListener(v ->  {
            model.addBeerToFridge(model.getBeer().getValue().getId());
            dialog.dismiss();
        });
        view.findViewById(R.id.addPrivateNote).setOnClickListener(v -> {
            ...
            String note = (!model.getNotes().getValue().isEmpty()) ? model.getNotes().getValue().get(0).getNote() : "";
            intent.putExtra(CreateNoteActivity.NOTE, note);
    ...
    private void updateNotes(List<MyNote> notes) {
    ...
    @Override
    public void onEditClickedListener(MyNote note) {
        Intent intent = new Intent(this, CreateNoteActivity.class);
        intent.putExtra(CreateNoteActivity.ITEM, model.getBeer().getValue());
        intent.putExtra(CreateNoteActivity.NOTE, note.getNote());
        startActivity(intent);
    }

    @Override
    public void onRemoveClickedListener(MyNote note) {
