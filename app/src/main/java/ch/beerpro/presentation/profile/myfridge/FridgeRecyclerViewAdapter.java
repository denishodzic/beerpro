...
public class FridgeRecyclerViewAdapter extends ListAdapter<Pair<MyFridge, Beer>, FridgeRecyclerViewAdapter.ViewHolder> {

    private static final String TAG = "FridgeRecyclerViewAda";

    private static final DiffUtil.ItemCallback<Pair<MyFridge, Beer>> DIFF_CALLBACK = new EntityPairDiffItemCallback<>();
    ...
    public void onBindViewHolder(@NonNull final FridgeRecyclerViewAdapter.ViewHolder holder, int position) {
        Pair<MyFridge, Beer> item = getItem(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(MyFridge fridge, Beer item, OnFridgeItemInteractionListener listener) {
            ...
            remove.setOnClickListener(v -> listener.onRemoveFridgeClickedListener(item));
            save.setOnClickListener(v -> listener.onSaveFridgeClickedListener(item, amount.getText().toString()));
        }
    }
}
